...
<div class="container">
        ...
        <form action="processa_excluir.php" method="post">
            ...
            <input type="text" class="form-control" name="nome" id="nome" value="<?php echo $jogos['nome'] ?>" readonly>


           <br>

            <label for="categoria">Categoria (ou Gênero):</label>
            <input type="text" class="form-control" name="categoria" id="categoria" value="<?php echo $jogos['categoria'] ?>" required readonly>
       ...
       <?php $selectedValue = $jogos['classificacao'];?>
        ...
        <option value="adulto" <?php echo $selectedValue === 'adulto' ? 'selected' : ''; ?>>+ 18 anos</option>
            ...
            <input type="number" name="ano" id="ano" min="1900" required value="<?php echo $jogos['ano'] ?>" readonly>

            
            <br><br>

            <label for="valor">Valor em Reais:</label>
            <input type="number" name="valor" id="valor" step="0.01" min="0" value="<?php echo $jogos['valor'] ?>" required readonly>
