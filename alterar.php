    ...
    <div class="container">
        ...
        <form action="processa_alterar.php" method="post">
            ...
            <div class="col-md-6 mb-4">
                ...
                <input type="text" class="form-control" name="nome" id="nome" placeholder=" " value="<?php echo $jogos['nome'] ?>" required>
            ...
            <div class="col-md-6 mb-4">
                <div data-mdb-input-init class="form-floating-custom">
                <input type="text" class="form-control" name="categoria" id="categoria" placeholder=" " value="<?php echo $jogos['categoria'] ?>" required>
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-4">
                <div data-mdb-input-init class="form-floating-custom">
                <input type="number" name="ano" id="ano" min="1900" class="form-control" placeholder=" " value="<?php echo $jogos['ano'] ?>" required>
            ...
            <div class="col-md-6 mb-4">
                <div data-mdb-input-init class="form-floating-custom">
                <input type="number" name="valor" id="valor"  step="0.01" min="0" class="form-control" placeholder=" " value="<?php echo $jogos['valor'] ?>" required>
